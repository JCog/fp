...
struct menu *create_warps_menu(void)
{
    ...
    menu_add_submenu(&menu, 0, 1, &favorite_rooms_menu, "favorite rooms");
    menu_add_submenu(&menu, 0, 2, &locations_menu, "locations");
    menu_add_submenu(&menu, 0, 3, &bosses_menu, "bosses");
