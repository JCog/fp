...
struct group_info GROUPS[] = {
    ...
    {"peach's castle",              0x19, {{"main 1 (light)", 0x7}, {"main 2 (light)", 0x7}, {"hallway 1 (light)", 0x2}, {"hallway bowser (light)", 0x3}, {"main 1 (dark)", 0x5}, {"main 2 (dark)", 0x8}, {"hallway 1 (dark)", 0x2}, {"hallway bowser (dark)", 0x4}, {"peach's room", 0xc}, {"bowser's diary", 0x3}, {"library", 0x1}, {"mysterious chest", 0x1}, {"gourmet guy", 0x1}, {"kitchen", 0x1}, {"toad house", 0x1}, {"quiz show (packed up)", 0x1}, {"far-right stairs", 0x2}, {"outside hallway", 0x2}, {"spiral staircase", 0x2}, {"final bowser", 0x3}, {"peach's balcony 1", 0x3}, {"peach's balcony 2", 0x3}, {"secret passage", 0x2}, {"quiz show (unused)", 0x1}, {"quiz show", 0x1}}},
    {"star region",
     0x9,
