...
static const u16 itemsNormalFood[] = {
...
static const u16 itemsNormalUnused[] = {
    0x87, 0x91, 0x99, 0xDB, 0xDC, 0xDD, 0xDE, 0xDF,
};

static const u16 itemsKeyRequired[] = {
...
static const u16 itemsKeyOther[] = {
...
static const u16 itemsKeyLetters[] = {
...
static const u16 itemsBadgesUnused[] = {
...
static void createItemSelectionPage(struct Menu *page, const char *title, struct GfxTexture *itemTextureList[],
                                    const u16 *itemLists[], const u16 itemListSizes[], u16 itemListCount) {
    ...
    for (s32 iLists = 0; iLists < itemListCount; iLists++) {
        ...
        for (s32 iPos = 0; iPos < itemListSizes[iLists]; iPos++) {
            ...
            struct MenuItem *button = menuAddButtonIcon(page, itemX, itemY, icon, 0, 0, 0xFFFFFF, scale,
                                                        itemSelectionButtonProc, (void *)(u32)itemId);
...
void createItemSelectionMenu(struct GfxTexture *itemTextureList[]) {
    ...
    const u16 *listItems1[] = {itemsNormalFood, itemsNormalOther};
    const u16 *listItems2[] = {itemsNormalTayce, itemsNormalUnused};
    const u16 *listKey1[] = {itemsKeyRequired, itemsKeyOther};
    const u16 *listKey2[] = {itemsKeyLetters, itemsKeyUnused};
    const u16 *listBadges1[] = {itemsBadges};
    const u16 *listBadges2[] = {itemsBadgesUnused};
    const u16 *listMisc[] = {itemsMisc};

    const u16 sizesItems1[] = {ARRAY_LENGTH(itemsNormalFood), ARRAY_LENGTH(itemsNormalOther)};
    const u16 sizesItems2[] = {ARRAY_LENGTH(itemsNormalTayce), ARRAY_LENGTH(itemsNormalUnused)};
    const u16 sizesKey1[] = {ARRAY_LENGTH(itemsKeyRequired), ARRAY_LENGTH(itemsKeyOther)};
    const u16 sizesKey2[] = {ARRAY_LENGTH(itemsKeyLetters), ARRAY_LENGTH(itemsKeyUnused)};
    const u16 sizesBadges1[] = {ARRAY_LENGTH(itemsBadges)};
    const u16 sizesBadges2[] = {ARRAY_LENGTH(itemsBadgesUnused)};
    const u16 sizesMisc[] = {ARRAY_LENGTH(itemsMisc)};
