...
struct menu_item {
    ...
    _Bool selectable;
    struct menu *imenu;
    int (*enter_proc)(struct menu_item *item, enum menu_switch_reason reason);
    int (*leave_proc)(struct menu_item *item, enum menu_switch_reason reason);
    int (*think_proc)(struct menu_item *item);
    int (*draw_proc)(struct menu_item *item, struct menu_draw_params *draw_params);
    int (*navigate_proc)(struct menu_item *item, enum menu_navigation nav);
