...
local fp = gru.blob_load("bin/" .. fp_version .. "/fp.bin")
...
local ldr = gru.blob_load("bin/ldr-" .. fp_version .. "/ldr.bin")

print("Inserting payload")
rom:write(rom_info.ldr_rom, ldr)
rom:write(payload_rom, old_ldr)
local payload = gru.blob_load("bin/" .. fp_version .. "/fp.bin")
rom:write(fp_rom, fp)
rom:crc_update()

return rom, rom_info, fp_version